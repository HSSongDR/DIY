...
class MainTest {
	...
	void DelTest() {
		...
		assertEquals(
				"DEL,96555555,VSID TVO,CL1,010-3669-1077,20120718,PRO\n"
						...
						+ "DEL,17111236,VSID TVO,CL1,010-3669-1077,20120718,PRO",
				DB.run(t4.split(",")).toString().trim());
