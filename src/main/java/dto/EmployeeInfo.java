...
public class EmployeeInfo {
	...
	public String getObj(String sObject) {
		if (sObject.equals("employeeNum"))
			return employeeNum;
		else if (sObject.equals("name"))
			return name;
		else if (sObject.equals("namef"))
			return namef;
		else if (sObject.equals("namel"))
			return namel;
		else if (sObject.equals("cl"))
			return cl;
		else if (sObject.equals("phoneNum"))
			return phoneNum;
		else if (sObject.equals("phoneNumm"))
			return phoneNumm;
		else if (sObject.equals("phoneNuml"))
			return phoneNuml;
		else if (sObject.equals("birthday"))
			return birthday;
		else if (sObject.equals("birthdayy"))
			return birthdayy;
		else if (sObject.equals("birthdaym"))
			return birthdaym;
		else if (sObject.equals("birthdayd"))
			return birthdayd;
		else if (sObject.equals("certi"))
			return certi;
	...
	public void setObj(String sObject, String changeValue) {
		if (sObject.equals("name")) {
			...
			this.namef = changeValue;
		else if (sObject.equals("namel"))
			this.namel = changeValue;
		else if (sObject.equals("cl"))
			this.cl = changeValue;
		else if (sObject.equals("phoneNum")) {
			...
			this.phoneNumm = changeValue;
		else if (sObject.equals("phoneNuml"))
			this.phoneNuml = changeValue;
		else if (sObject.equals("birthday")) {
			...
			this.birthdayy = changeValue;
		else if (sObject.equals("birthdaym"))
			this.birthdaym = changeValue;
		else if (sObject.equals("birthdayd"))
			this.birthdayd = changeValue;
		else if (sObject.equals("certi"))
			this.certi = changeValue;
	}
	...
	public String toString() {
		...
		return employeeNum + Constants.DELIMITER_COMMA + name + Constants.DELIMITER_COMMA + cl
				+ Constants.DELIMITER_COMMA + phoneNum + Constants.DELIMITER_COMMA + birthday
				+ Constants.DELIMITER_COMMA + certi;
	}
}
